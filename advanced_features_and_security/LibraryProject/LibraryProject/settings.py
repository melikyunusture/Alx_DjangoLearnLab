...
DATABASES = {
   'default': {
        ...
        'NAME': 'books',
        'USER': 'root',
        'PASSWORD': 'root1234',  # <-- must not be empty
        'HOST': 'localhost',
...
# Setting to trust the X-Forwarded-Proto header, essential when running behind a proxy
# to correctly detect a secure connection.
